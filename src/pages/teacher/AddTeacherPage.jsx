        ...
        <div className='flex-1 flex flex-col space-y-7 h-full overflow-hidden scrollbar-none w-auto m-0'>
            ...
            <div className='flex-1 min-h-0 overflow-auto scrollbar-thin flex flex-col space-y-8'>
                <div className='rounded-xl flex-1 min-h-0 flex flex-col space-y-8'>
                    <div>
                        <div className='rounded-t-2xl bg-primary px-8 py-2.5 text-white font-bold text-[18px]'>Personal Details</div>
                        <div className='flex-1 rounded-b-2xl bg-white p-5'>
                            <div className='flex flex-col space-y-2 lg:w-[90%]'>
                                ...
                                <div className='w-full flex flex-col lg:flex-row space-y-5 lg:space-x-5 lg:space-y-0'>
                                    ...
                                    <TextInput required="true" label="Date of Birth" />
                                    <TextInput required="true" label="Place of Birth" />
                    ...
                    <div>
                        <div className='rounded-t-2xl bg-primary px-8 py-2.5 text-white font-bold text-[18px]'>Education</div>
                        <div className='flex-1 rounded-b-2xl bg-white p-5'>
                            <div className='flex flex-col space-y-2 lg:w-[90%]'>
                                ...
                                <div className='w-full flex flex-col lg:flex-row space-y-5 lg:space-x-5 lg:space-y-0'>
                                    ...
                                    <TextInput required="true" label="University" placeholder="Ladoke Akintola University of Technology" />
                                    <TextInput required="true" label="Degree" placeholder="History Major" />

                                </div>

                                <div className='w-full flex flex-col lg:flex-row space-y-5 lg:space-x-5 lg:space-y-0'>
                                    <div className='flex space-x-3 items-end w-full'>
                                        <TextInput required="true" label="Start & End Date" placeholder="September 2013" />
                                        <TextInput required="true" placeholder="September 2017" />
                                    </div>
                                    <TextInput required="true" label="City" placeholder="Yoaco, Ogbomoso" />
                    ...
                    <div>
                        <div className='flex-1 flex justify-end space-x-3 mb-2'>
                            ...
                            <Button size={"px-3 py-2 text-xs"} onClick={() => navigate("/teachers")}
